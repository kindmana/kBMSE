...
export const translations = {
  ...
  ko: {
    ...
    base62Mode: '진수 관리 모드 (Base 36/62)',
    base62ModeAuto: '자동 (파일 기준 감지)',
    base62Mode36: '36진수 고정',
    base62Mode62: '62진수 고정',
  ...
  ja: {
    ...
    base62Mode: '進数管理モード (Base 36/62)',
    base62ModeAuto: '自動 (ファイル基準検出)',
    base62Mode36: '36進数固定',
    base62Mode62: '62進数固定',
